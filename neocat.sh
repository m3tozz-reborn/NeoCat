# NeoCat Updater
remote_url="https://raw.githubusercontent.com/m3tozz-reborn/NeoCat/main/neocat.sh"
local_file="$0"
tmp_file=$(mktemp)
...
if [ "$remote_ver" != "$local_ver" ]; then
    ...
    if [ -d ".git" ]; then
        ...
        echo -e "To update manually, run:\n\e[1;34mgit clone --depth 1 https://github.com/m3tozz-reborn/NeoCat.git && cd NeoCat && bash ./neocat.sh --shell\e[0m"
        sleep 2
    fi
fi
