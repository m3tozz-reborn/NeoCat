...
>
> Until my account is reactive, you can access **NeoCat** from here.
>
...
--
```bash
git clone --depth 1 https://github.com/m3tozz-reborn/NeoCat.git && cd NeoCat && bash ./neocat.sh --shell
```

Install (Manual)
--
```bash
git clone https://github.com/m3tozz-reborn/NeoCat.git 
```
```bash
cd NeoCat 
```
